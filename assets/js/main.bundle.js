( () => {
    ...
    const a = new class {
      ...
      , o = new class {
        ...
        drawLeaderboard() {
            ...
            s.clearRect(0, 0, i.width, i.height),
            s.fillStyle = "#FFFFFF",
            s.font = `500 ${25 * c}px Ubuntu`;
            const d = s.measureText("Leaderboard").width;
            s.fillText("Leaderboard", (i.width - d) / 2, 32 * c),
            s.font = `500 ${16 * c}px Ubuntu`,
            s.textAlign = "left",
            s.textBaseline = "top",
            e.items.slice(0, 10).forEach(( (t, e) => {
                ...
                s.fillText(` ${t.pos}.  [${n = t.mass,
                n >= 1e3 ? (n / 1e3).toFixed(1) + "k" : n.toString()}]  ${t.name}`, 10 * c, i)
            }
            ))
        }
    ...
    class h {
        ...
        animate(t) {
            const cellSpeed = Math.max(g.settings.cellSpeed / 20, 1);
    ...
    class u extends t {
        ...
        renderTurnstile() {
            ...
            turnstile.render(e, {
                ...
                callback: e => {
                    console.log("Turnstile Token:", e),
                    this.sendCaptcha(1, e),
